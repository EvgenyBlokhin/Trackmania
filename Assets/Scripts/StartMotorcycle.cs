...
public class StartMotorcycle : MonoBehaviour
{
    ...
    void Start() {
        ...
        if (Wheelchair) {
            WheelchairText.text = "Yes";
        } else {
            WheelchairText.text = "No";
        }
        if (punctureWheel) {
            InitializePuncture();
        }
    ...
    void Update() {
        ...
        passedInMetersText.text = "Motorcycle: " + passedInMeters.ToString() + "m.";
    }
